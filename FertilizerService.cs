    ...
    public class FertilizerService
    {
        ...
        private void InitializeFertilizers()
        {
            fertilizers = new Dictionary<string, Fertilizer>
            {
                ...
                { "Calcium Nitrate", new Fertilizer { Name = "Calcium Nitrate", N = 40.95, P = 0, K = 0, Mg = 15, Ca = 50.19, S = 0, Fe = 0, Zn = 0, B = 0, Mn = 0, Cu = 0, Mo = 0, PPM = 91.14 } },
                { "CaliMagic", new Fertilizer { Name = "CaliMagic", N = 2.64, P = 0, K = 0, Mg = 3.962, Ca = 13.208, S = 0, Fe = 0.264, Zn = 0, B = 0, Mn = 0, Cu = 0, Mo = 0, PPM = 20.066 } },
                { "Canna Boost", new Fertilizer { Name = "Canna Boost", N = 0, P = 1.153, K = 2.193, Mg = 0, Ca = 0, S = 0, Fe = 0, Zn = 0, B = 0, Mn = 0, Cu = 0, Mo = 0, PPM = 3.34 } },
                ...
                { "CannaCoco A", new Fertilizer { Name = "CannaCoco A", N = 10.0039, P = 0, K = 1.32, Mg = 1.06, Ca = 11.9, S = 0, Fe = 0.0528, Zn = 0, B = 0, Mn = 0, Cu = 0, Mo = 0, PPM = 24.3328 } },
                { "CannaCoco B", new Fertilizer { Name = "CannaCoco B", N = 2.64, P = 4.61, K = 4.39, Mg = 2.91, Ca = 0, S = 1.85, Fe = 0, Zn = 0.0185, B = 0.0185, Mn = 0.0317, Cu = 0.00264, Mo = 0.00528, PPM = 16.47662 } },
                { "Canna Flores A", new Fertilizer { Name = "Canna Flores A", N = 7.925, P = 0, K = 13.158, Mg = 0, Ca = 0, S = 0, Fe = 0, Zn = 0, B = 0, Mn = 0, Cu = 0, Mo = 0, PPM = 21.083 } },
                { "Canna Flores B", new Fertilizer { Name = "Canna Flores B", N = 0, P = 4.612, K = 6.579, Mg = 0, Ca = 0, S = 0, Fe = 0, Zn = 0, B = 0, Mn = 0, Cu = 0, Mo = 0, PPM = 11.191 } },
                { "Canna PH Down", new Fertilizer { Name = "Canna PH Down", N = 2.64, P = 0, K = 0, Mg = 0, Ca = 0, S = 0, Fe = 0, Zn = 0, B = 0, Mn = 0, Cu = 0, Mo = 0, PPM = 2.64 } },
                { "Canna PK13/14", new Fertilizer { Name = "Canna PK13/14", N = 0, P = 11.53, K = 24.123, Mg = 0, Ca = 0, S = 0, Fe = 0, Zn = 0, B = 0, Mn = 0, Cu = 0, Mo = 0, PPM = 35.6 } },
                { "Canna Vega A", new Fertilizer { Name = "Canna Vega A", N = 13.2, P = 0, K = 4.39, Mg = 0.5581, Ca = 2.2333, S = 0, Fe = 0, Zn = 0, B = 0, Mn = 0, Cu = 0, Mo = 0, PPM = 12.0867 } },
                { "Canna Vega B", new Fertilizer { Name = "Canna Vega B", N = 0, P = 3.459, K = 8.772, Mg = 0, Ca = 0, S = 0, Fe = 0, Zn = 0, B = 0, Mn = 0, Cu = 0, Mo = 0, PPM = 12.231 } },
